...
import com.github.crossfx.sun.javafx.fxml.LoadListener;
import com.github.crossfx.sun.javafx.fxml.ParseTraceElement;
import com.github.crossfx.sun.javafx.fxml.PropertyNotFoundException;
import com.github.crossfx.sun.javafx.fxml.expression.Expression;
import com.github.crossfx.sun.javafx.fxml.expression.ExpressionValue;
import com.github.crossfx.sun.javafx.fxml.expression.KeyPath;
...
public class CrossFxmlLoader {
    ...
    private abstract class Element {
        ...
        public void add(Object element) throws com.github.crossfx.javafx.fxml.LoadException {
        ...
        public void set(Object value) throws com.github.crossfx.javafx.fxml.LoadException {
            if (this.value == null) {
        ...
        private boolean processValue(Class sourceType, String propertyName, String aValue)
            throws com.github.crossfx.javafx.fxml.LoadException {
         ...
         */
        private Object resolvePrefixedValue(String aValue) throws com.github.crossfx.javafx.fxml.LoadException {
                ...
                if (aValue.startsWith(RELATIVE_PATH_PREFIX)) {
                    ...
                    return aValue;
                        ...
                        if (aValue.charAt(0) == '/') {
                            ...
                            try {
                                return new URL(CrossFxmlLoader.this.location, aValue).toString();
                            } catch (MalformedURLException e) {
                                System.err.println(CrossFxmlLoader.this.location + "/" + aValue);
                            }
                        }
                }
        ...
        private Object populateArrayFromString(
                Class<?>type,
                String stringValue) throws com.github.crossfx.javafx.fxml.LoadException {
        ...
        private Object getExpressionObject(String handlerValue) throws com.github.crossfx.javafx.fxml.LoadException {
        ...
        private <T> T getExpressionObjectOfType(String handlerValue, Class<T> type) throws com.github.crossfx.javafx.fxml.LoadException {
        ...
        private Callback1 getControllerMethod(String handlerName) throws com.github.crossfx.javafx.fxml.LoadException {
            if (handlerName.startsWith(CONTROLLER_METHOD_PREFIX)) {
                ...
                if (!handlerName.startsWith(CONTROLLER_METHOD_PREFIX)) {
                    ...
                    if(!controller.hasMethod(handlerName)){
                        throw new com.github.crossfx.javafx.fxml.LoadException("Controller has no method named \"" + handlerName + "\'");
                    }
        ...
        public void processEventHandlerAttributes() throws com.github.crossfx.javafx.fxml.LoadException {
        ...
        private void processObservableListHandler(String handlerValue) throws com.github.crossfx.javafx.fxml.LoadException {
        ...
        private void processObservableMapHandler(String handlerValue) throws com.github.crossfx.javafx.fxml.LoadException {
        ...
        private void processObservableSetHandler(String handlerValue) throws com.github.crossfx.javafx.fxml.LoadException {
        ...
        private void processPropertyHandler(String attributeName, String handlerValue) throws com.github.crossfx.javafx.fxml.LoadException {
    ...
    private abstract class ValueElement extends Element {
        ...
        private void processValue() throws com.github.crossfx.javafx.fxml.LoadException {
        ...
        @Override
        @SuppressWarnings("unchecked")
        public void processCharacters() throws com.github.crossfx.javafx.fxml.LoadException {
            Class<?> type = value.getClass();
            DefaultProperty defaultProperty = type.getAnnotation(DefaultProperty.class);
        ...
        public void processAttribute(String prefix, String localName, String value)
            ...
            if (prefix != null
                ...
                if (localName.equals(FX_ID_ATTRIBUTE)) {
                    ...
                    throw new com.github.crossfx.javafx.fxml.LoadException("JSFX does not support the fx controller attribute: " + localName);
                } else {
    ...
    private class InstanceDeclarationElement extends ValueElement {
        ...
        public InstanceDeclarationElement(Class<?> type) throws com.github.crossfx.javafx.fxml.LoadException {
            this.type = type;
        }
    ...
    private class UnknownTypeElement extends ValueElement {
        ...
        @Override
        public Object constructValue() throws com.github.crossfx.javafx.fxml.LoadException {
    ...
    private class IncludeElement extends ValueElement {
        ...
        public ResourceBundle resources = CrossFxmlLoader.this.resources;
        public Charset charset = CrossFxmlLoader.this.charset;
            ...
            if (prefix == null) {
                if (localName.equals(INCLUDE_SOURCE_ATTRIBUTE)) {
                    ...
                    resources = ResourceBundle.getBundle(value, Locale.getDefault(),
                            CrossFxmlLoader.this.resources.getClass().getClassLoader());
        ...
        public Object constructValue() throws IOException {
            ...
            if (source.charAt(0) == '/') {
                ...
                if (CrossFxmlLoader.this.location == null) {
                    throw constructLoadException("Base location is undefined.");
                }

                location = new URL(CrossFxmlLoader.this.location, source);
            }

            CrossFxmlLoader crossFxmlLoader = new CrossFxmlLoader(
                location, 
                resources,
                builderFactory, 
                controllerFactory,
            ...
            crossFxmlLoader.parentLoader = CrossFxmlLoader.this;

            if (isCyclic(CrossFxmlLoader.this, crossFxmlLoader)) {
                throw new IOException(
                        String.format(
                        "Including \"%s\" in \"%s\" created cyclic reference.",
                        crossFxmlLoader.location.toExternalForm(),
                        CrossFxmlLoader.this.location.toExternalForm()));
            }
            crossFxmlLoader.setClassLoader(cl);
            crossFxmlLoader.impl_setStaticLoad(staticLoad);

            if(!controller.hasNestedController(fx_id)){
                throw new com.github.crossfx.javafx.fxml.LoadException(
            ...
            crossFxmlLoader.setController(nestedController);
            nestedController.setFxmlLoader(crossFxmlLoader);
            Object value = crossFxmlLoader.loadImpl(callerClass);

            if (fx_id != null) {
                String id = this.fx_id + CONTROLLER_SUFFIX;
                Object controller = crossFxmlLoader.getController();

                namespace.put(id, controller);

                if (CrossFxmlLoader.this.controller != null) {
                    Field field = controllerAccessor.getControllerFields()
                                                    .get(id);

                    if (field != null) {
                        try {
                            field.set(CrossFxmlLoader.this.controller, controller);
                        } catch (IllegalAccessException exception) {
                            throw constructLoadException(exception);
                        }
                    }
    ...
    private class PropertyElement extends Element {
        ...
        public PropertyElement(String name, Class<?> sourceType) throws com.github.crossfx.javafx.fxml.LoadException {
            if (parent == null) {
    ...
    private class UnknownStaticPropertyElement extends Element {
        public UnknownStaticPropertyElement() throws com.github.crossfx.javafx.fxml.LoadException {
            if (parent == null) {
                throw constructLoadException("Invalid root element.");
            }
    ...
    private final LinkedList<CrossFxmlLoader> loaders;

    private ClassLoader classLoader = null;
    private boolean staticLoad = false;
    private LoadListener loadListener = null;

    private CrossFxmlLoader parentLoader;
     ...
     * @since JavaFX 2.1
     */
    public CrossFxmlLoader(URL location) {
        this(location, null);
    }
     ...
     * @since JavaFX 2.1
     */
    public CrossFxmlLoader(URL location, ResourceBundle resources) {
        this(location, resources, new com.github.crossfx.javafx.fxml.JavaFXBuilderFactory());
    }
     ...
     * @since JavaFX 2.1
     */
    public CrossFxmlLoader(URL location, ResourceBundle resources, BuilderFactory builderFactory) {
     ...
     * @param charset
     */
    public CrossFxmlLoader(Charset charset) {
    ...
    public CrossFxmlLoader(URL location, ResourceBundle resources, BuilderFactory builderFactory,
        ...
        this(location, resources, builderFactory, controllerFactory, charset,
            new LinkedList<CrossFxmlLoader>());
    }
    ...
    public CrossFxmlLoader(URL location, ResourceBundle resources, BuilderFactory builderFactory,
                           Callback<Class<?>, Object> controllerFactory, Charset charset,
                           LinkedList<CrossFxmlLoader> loaders) {
    ...
    public boolean equals(Object obj) {
        if (obj instanceof CrossFxmlLoader) {
            CrossFxmlLoader loader = (CrossFxmlLoader)obj;
    ...
    private boolean isCyclic(
                            CrossFxmlLoader currentLoader,
                            CrossFxmlLoader node) {
    ...
    private <T> T loadImpl(InputStream inputStream,
        ...
        try {
            ...
            if (controller != null) {
                if (controller instanceof com.github.crossfx.javafx.fxml.Initializable) {
                    ((com.github.crossfx.javafx.fxml.Initializable)controller).initialize(location, resources);
                } else {
        ...
        } catch (final com.github.crossfx.javafx.fxml.LoadException exception) {
            throw exception;
    ...
    private com.github.crossfx.javafx.fxml.LoadException constructLoadException(String message){
        return new com.github.crossfx.javafx.fxml.LoadException(message + constructFXMLTrace());
    }

    private com.github.crossfx.javafx.fxml.LoadException constructLoadException(Throwable cause) {
        return new com.github.crossfx.javafx.fxml.LoadException(constructFXMLTrace(), cause);
    }

    private com.github.crossfx.javafx.fxml.LoadException constructLoadException(String message, Throwable cause){
        return new com.github.crossfx.javafx.fxml.LoadException(message + constructFXMLTrace(), cause);
    }

    private String constructFXMLTrace() {
        StringBuilder messageBuilder = new StringBuilder("\n");

        for (CrossFxmlLoader loader : loaders) {
    ...
    private void processProcessingInstruction() throws com.github.crossfx.javafx.fxml.LoadException {
    ...
    private void processLanguage() throws com.github.crossfx.javafx.fxml.LoadException {
    ...
    private void processImport() throws com.github.crossfx.javafx.fxml.LoadException {
    ...
    private void processComment() throws com.github.crossfx.javafx.fxml.LoadException {
        if (loadListener != null) {
    ...
    private void importPackage(String name) throws com.github.crossfx.javafx.fxml.LoadException {
        packages.add(name);
    }

    private void importClass(String name) throws com.github.crossfx.javafx.fxml.LoadException {
        try {
            loadType(name, true);
    ...
    private Class<?> getType(String name) throws com.github.crossfx.javafx.fxml.LoadException {
        Class<?> type = null;
        ...
        if (defaultClassLoader == null) {
            ...
            if (sm != null) {
                final ClassLoader callerClassLoader = (caller != null) ?
                        ...
                        null;
                if (needsClassLoaderPermissionCheck(callerClassLoader, CrossFxmlLoader.class.getClassLoader())) {
    ...
    public static void setDefaultClassLoader(ClassLoader defaultClassLoader) {
        ...
        CrossFxmlLoader.defaultClassLoader = defaultClassLoader;
    }
    ...
    private static <T> T loadImpl(URL location, ResourceBundle resources,
                                  Class<?> callerClass) throws IOException {
        return loadImpl(location, resources,  new com.github.crossfx.javafx.fxml.JavaFXBuilderFactory(),
                        callerClass);
    }
    ...
    private static <T> T loadImpl(URL location, ResourceBundle resources,
        ...
        CrossFxmlLoader fxmlLoader =
                new CrossFxmlLoader(location, resources, builderFactory,
