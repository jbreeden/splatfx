...
package com.github.crossfx.sun.javafx.fxml;
...
/**
 * Exposes Java Bean properties of an object via the {@link java.util.Map} interface.
 * A call to {@link java.util.Map#get(Object)} invokes the getter for the corresponding
 * property, and a call to {@link java.util.Map#put(Object, Object)} invokes the
