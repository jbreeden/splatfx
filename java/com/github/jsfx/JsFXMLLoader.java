...
import com.github.jsfx.sun.javafx.fxml.LoadListener;
import com.github.jsfx.sun.javafx.fxml.ParseTraceElement;
import com.github.jsfx.sun.javafx.fxml.PropertyNotFoundException;
import com.github.jsfx.sun.javafx.fxml.expression.Expression;
import com.github.jsfx.sun.javafx.fxml.expression.ExpressionValue;
import com.github.jsfx.sun.javafx.fxml.expression.KeyPath;
...
public class JsFXMLLoader {
    ...
    private abstract class Element {
        ...
        public void add(Object element) throws com.github.jsfx.javafx.fxml.LoadException {
        ...
        public void set(Object value) throws com.github.jsfx.javafx.fxml.LoadException {
            if (this.value == null) {
        ...
        private boolean processValue(Class sourceType, String propertyName, String aValue)
            throws com.github.jsfx.javafx.fxml.LoadException {
         ...
         */
        private Object resolvePrefixedValue(String aValue) throws com.github.jsfx.javafx.fxml.LoadException {
                ...
                if (aValue.startsWith(RELATIVE_PATH_PREFIX)) {
                    ...
                    return aValue;
                        ...
                        if (aValue.charAt(0) == '/') {
                            ...
                            try {
                                return new URL(JsFXMLLoader.this.location, aValue).toString();
                            } catch (MalformedURLException e) {
                                System.err.println(JsFXMLLoader.this.location + "/" + aValue);
                            }
                        }
                }
        ...
        private Object populateArrayFromString(
                Class<?>type,
                String stringValue) throws com.github.jsfx.javafx.fxml.LoadException {
        ...
        private Object getExpressionObject(String handlerValue) throws com.github.jsfx.javafx.fxml.LoadException {
        ...
        private <T> T getExpressionObjectOfType(String handlerValue, Class<T> type) throws com.github.jsfx.javafx.fxml.LoadException {
        ...
        private JsCallback1 getControllerMethod(String handlerName) throws com.github.jsfx.javafx.fxml.LoadException {
            if (handlerName.startsWith(CONTROLLER_METHOD_PREFIX)) {
                ...
                if (!handlerName.startsWith(CONTROLLER_METHOD_PREFIX)) {
                    ...
                    if(!controller.hasMethod(handlerName)){
                        throw new com.github.jsfx.javafx.fxml.LoadException("Controller has no method named \"" + handlerName + "\'");
                    }
                    JsCallback1 result = controller.getMethod(handlerName);
        ...
        public void processEventHandlerAttributes() throws com.github.jsfx.javafx.fxml.LoadException {
            if (eventHandlerAttributes.size() > 0 && !staticLoad) {
                for (Attribute attribute : eventHandlerAttributes) {
                    ...
                    if (value instanceof ObservableList && attribute.name.equals(COLLECTION_HANDLER_NAME)) {
                        ...
                        JsCallback1 callback = getControllerMethod(handlerName);
                        EventHandler<? extends Event> eventHandler = new JsEventHandler(callback);
        ...
        private void processObservableListHandler(String handlerValue) throws com.github.jsfx.javafx.fxml.LoadException {
            ObservableList list = (ObservableList)value;
            if (handlerValue.startsWith(CONTROLLER_METHOD_PREFIX)) {
                JsCallback1 callback = getControllerMethod(handlerValue);
                if (callback != null) {
        ...
        private void processObservableMapHandler(String handlerValue) throws com.github.jsfx.javafx.fxml.LoadException {
        ...
        private void processObservableSetHandler(String handlerValue) throws com.github.jsfx.javafx.fxml.LoadException {
        ...
        private void processPropertyHandler(String attributeName, String handlerValue) throws com.github.jsfx.javafx.fxml.LoadException {
            ...
            if (i != j) {
                ...
                if (handlerValue.startsWith(CONTROLLER_METHOD_PREFIX)) {
                    final JsCallback1 callback = getControllerMethod(handlerValue);
                    if (callback != null) {
    ...
    private abstract class ValueElement extends Element {
        ...
        private void processValue() throws com.github.jsfx.javafx.fxml.LoadException {
        ...
        @Override
        @SuppressWarnings("unchecked")
        public void processCharacters() throws com.github.jsfx.javafx.fxml.LoadException {
            Class<?> type = value.getClass();
            DefaultProperty defaultProperty = type.getAnnotation(DefaultProperty.class);
        ...
        public void processAttribute(String prefix, String localName, String value)
            ...
            if (prefix != null
                ...
                if (localName.equals(FX_ID_ATTRIBUTE)) {
                    ...
                    throw new com.github.jsfx.javafx.fxml.LoadException("JSFX does not support the fx controller attribute: " + localName);
                } else {
    ...
    private class InstanceDeclarationElement extends ValueElement {
        ...
        public InstanceDeclarationElement(Class<?> type) throws com.github.jsfx.javafx.fxml.LoadException {
            this.type = type;
        }
    ...
    private class UnknownTypeElement extends ValueElement {
        ...
        @Override
        public Object constructValue() throws com.github.jsfx.javafx.fxml.LoadException {
    ...
    private class IncludeElement extends ValueElement {
        ...
        public ResourceBundle resources = JsFXMLLoader.this.resources;
        public Charset charset = JsFXMLLoader.this.charset;
            ...
            if (prefix == null) {
                if (localName.equals(INCLUDE_SOURCE_ATTRIBUTE)) {
                    ...
                    resources = ResourceBundle.getBundle(value, Locale.getDefault(),
                            JsFXMLLoader.this.resources.getClass().getClassLoader());
        ...
        public Object constructValue() throws IOException {
            ...
            if (source.charAt(0) == '/') {
                ...
                if (JsFXMLLoader.this.location == null) {
                    throw constructLoadException("Base location is undefined.");
                }

                location = new URL(JsFXMLLoader.this.location, source);
            }

            JsFXMLLoader jsFxmlLoader = new JsFXMLLoader(
                location, 
                resources,
                builderFactory, 
                controllerFactory,
            ...
            jsFxmlLoader.parentLoader = JsFXMLLoader.this;

            if (isCyclic(JsFXMLLoader.this, jsFxmlLoader)) {
                throw new IOException(
                        String.format(
                        "Including \"%s\" in \"%s\" created cyclic reference.",
                        jsFxmlLoader.location.toExternalForm(),
                        JsFXMLLoader.this.location.toExternalForm()));
            }
            jsFxmlLoader.setClassLoader(cl);
            jsFxmlLoader.impl_setStaticLoad(staticLoad);

            if(!controller.hasNestedController(fx_id)){
                throw new com.github.jsfx.javafx.fxml.LoadException(
                    "No nested controller found for included element \"" 
                    + fx_id 
                    + "\". (Nested controller should be in a field named \"" + fx_id + "Controller\"");
            }
            JsController nestedController = controller.getNestedController(fx_id);
            jsFxmlLoader.setController(nestedController);
            nestedController.setFxmlLoader(jsFxmlLoader);
            Object value = jsFxmlLoader.loadImpl(callerClass);

            if (fx_id != null) {
                String id = this.fx_id + CONTROLLER_SUFFIX;
                Object controller = jsFxmlLoader.getController();

                namespace.put(id, controller);

                if (JsFXMLLoader.this.controller != null) {
                    Field field = controllerAccessor.getControllerFields()
                                                    .get(id);

                    if (field != null) {
                        try {
                            field.set(JsFXMLLoader.this.controller, controller);
                        } catch (IllegalAccessException exception) {
                            throw constructLoadException(exception);
                        }
                    }
    ...
    private class PropertyElement extends Element {
        ...
        public PropertyElement(String name, Class<?> sourceType) throws com.github.jsfx.javafx.fxml.LoadException {
            if (parent == null) {
    ...
    private class UnknownStaticPropertyElement extends Element {
        public UnknownStaticPropertyElement() throws com.github.jsfx.javafx.fxml.LoadException {
            if (parent == null) {
                throw constructLoadException("Invalid root element.");
            }
    ...
    private static class ObservableListChangeAdapter implements ListChangeListener {
        ...
        public ObservableListChangeAdapter(JsCallback1 callback) {
    ...
    private static class ObservableMapChangeAdapter implements MapChangeListener {
        public final JsCallback1 callback;

        public ObservableMapChangeAdapter(JsCallback1 callback) {
            this.callback = callback;
        }
    ...
    private static class ObservableSetChangeAdapter implements SetChangeListener {
        ...
        public ObservableSetChangeAdapter(JsCallback1 callback) {
            this.callback = callback;
        }
    ...
    private static class PropertyChangeAdapter implements ChangeListener<Object> {
        ...
        public PropertyChangeAdapter(JsCallback1 callback) {
            this.callback = callback;
        }
    ...
    private JsController controller = null;
    ...
    private final LinkedList<JsFXMLLoader> loaders;

    private ClassLoader classLoader = null;
    private boolean staticLoad = false;
    private LoadListener loadListener = null;

    private JsFXMLLoader parentLoader;
     ...
     * @since JavaFX 2.1
     */
    public JsFXMLLoader(URL location) {
        this(location, null);
    }
     ...
     * @since JavaFX 2.1
     */
    public JsFXMLLoader(URL location, ResourceBundle resources) {
        this(location, resources, new com.github.jsfx.javafx.fxml.JavaFXBuilderFactory());
    }
     ...
     * @since JavaFX 2.1
     */
    public JsFXMLLoader(URL location, ResourceBundle resources, BuilderFactory builderFactory) {
     ...
     * @param charset
     */
    public JsFXMLLoader(Charset charset) {
    ...
    public JsFXMLLoader(URL location, ResourceBundle resources, BuilderFactory builderFactory,
        Callback<Class<?>, Object> controllerFactory, Charset charset,
        LinkedList<JsFXMLLoader> loaders) {
    ...
    public boolean equals(Object obj) {
        if (obj instanceof JsFXMLLoader) {
            JsFXMLLoader loader = (JsFXMLLoader)obj;
     ...
     * @since JavaFX 2.2
     */
    public void setController(JsController controller) {
        this.controller = controller;
    ...
    private <T> T loadImpl(InputStream inputStream,
        ...
        try {
            ...
            if (controller != null) {
                if (controller instanceof com.github.jsfx.javafx.fxml.Initializable) {
                    ((com.github.jsfx.javafx.fxml.Initializable)controller).initialize(location, resources);
                } else {
        ...
        } catch (final com.github.jsfx.javafx.fxml.LoadException exception) {
            throw exception;
    ...
    private com.github.jsfx.javafx.fxml.LoadException constructLoadException(String message){
        return new com.github.jsfx.javafx.fxml.LoadException(message + constructFXMLTrace());
    }

    private com.github.jsfx.javafx.fxml.LoadException constructLoadException(Throwable cause) {
        return new com.github.jsfx.javafx.fxml.LoadException(constructFXMLTrace(), cause);
    }

    private com.github.jsfx.javafx.fxml.LoadException constructLoadException(String message, Throwable cause){
        return new com.github.jsfx.javafx.fxml.LoadException(message + constructFXMLTrace(), cause);
    }

    private String constructFXMLTrace() {
        StringBuilder messageBuilder = new StringBuilder("\n");

        for (JsFXMLLoader loader : loaders) {
    ...
    private void processProcessingInstruction() throws com.github.jsfx.javafx.fxml.LoadException {
    ...
    private void processLanguage() throws com.github.jsfx.javafx.fxml.LoadException {
    ...
    private void processImport() throws com.github.jsfx.javafx.fxml.LoadException {
    ...
    private void processComment() throws com.github.jsfx.javafx.fxml.LoadException {
        if (loadListener != null) {
    ...
    private void importPackage(String name) throws com.github.jsfx.javafx.fxml.LoadException {
        packages.add(name);
    }

    private void importClass(String name) throws com.github.jsfx.javafx.fxml.LoadException {
        try {
            loadType(name, true);
    ...
    private Class<?> getType(String name) throws com.github.jsfx.javafx.fxml.LoadException {
        Class<?> type = null;
        ...
        if (defaultClassLoader == null) {
            ...
            if (sm != null) {
                final ClassLoader callerClassLoader = (caller != null) ?
                        ...
                        null;
                if (needsClassLoaderPermissionCheck(callerClassLoader, JsFXMLLoader.class.getClassLoader())) {
    ...
    public static void setDefaultClassLoader(ClassLoader defaultClassLoader) {
        ...
        JsFXMLLoader.defaultClassLoader = defaultClassLoader;
    }
    ...
    private static <T> T loadImpl(URL location, ResourceBundle resources,
                                  Class<?> callerClass) throws IOException {
        return loadImpl(location, resources,  new com.github.jsfx.javafx.fxml.JavaFXBuilderFactory(),
                        callerClass);
    }
    ...
    private static <T> T loadImpl(URL location, ResourceBundle resources,
        ...
        JsFXMLLoader fxmlLoader =
                new JsFXMLLoader(location, resources, builderFactory,
    ...
    // TODO: This class should disappear as JsController is implemented
    private static final class ControllerAccessor {
        ...
        void setController(final Object controller) {
            if (this.controller != controller) {
                this.controller = (JsController)controller;
                reset();
            }
        }
